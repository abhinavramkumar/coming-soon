        ...
        <div className="container">
          <section className="Home">
            ...
            <article className="Home__Intro">
              ...
              <p>
                I enjoy building productivity tools, because that's so original.
              </p>
              <p>
                I love playing with data and finding intuitive new ways to
                visualize it.
              </p>
            ...
            <article className="Home__Tech-Stack">
              ...
              <div className="Home__Tech-Icons-Wrapper">
                <div className="Home__Tech-Icon react">
                  <svg
                ...
                <div className="Home__Tech-Icon nodejs">
                ...
                <div className="Home__Tech-Icon mongodb">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                ...
                <div className="Home__Tech-Icon amazon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <path
                      fill="#F7A80D"
                ...
                <div className="Home__Tech-Icon sass">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                ...
                <div className="Home__Tech-Icon git">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <path
                      fill="#F34F29"
                ...
                <div className="Home__Tech-Icon heroku">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
                    <g fill="#6762A6">
